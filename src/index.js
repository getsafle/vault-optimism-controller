...
class KeyringController extends EventEmitter {
    ...
    addNewKeyring(type, opts) {
        console.log("addNewKeyring CALLED.....")
    ...
    */
    ...
    async signMessage(msgParams, opts = {}) {
        ...
        // console.log(address)
        // const abc = await this.getKeyringForAccount(address)
        // console.log(abc)
        // const signedMsg = abc.signMessage(address, msgParams.data, opts)
    ...
    persistAllKeyrings(password = this.password) {
        console.log("persistAllKeyrings CALLED .......")
        if (typeof password !== 'string') {
